...
var IS_AVAILABLE_MEMOIZE_TTL = 60000;
...
function handleRequest(req, res) {
  ...
  return memoizedIsAvailableOnS3(ctx, function(err, isAvailable) {
    ...
    if (isAvailable) {
      ...
      // HACK: do not cache isAvailable==false
      memoizedIsAvailableOnS3.delete(ctx);
...
var memoizedIsAvailableOnS3 = memoize(isAvailableOnS3, {
  async: true,
  primitive: true,
  maxAge: IS_AVAILABLE_MEMOIZE_TTL,
  preFetch: true,
  max: 10240
});
